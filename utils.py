...
class Static_Transmit(nn.Module):
    def __init__(self, transmit,c_in,tem_size, num_nodes, cluster_nodes):
        super(Static_Transmit,self).__init__()
    ...
    def forward(self, seq, seq_cluster):
        ...
        logits = torch.sigmoid(torch.matmul(f1, f2))
        return logits * self.transmit
